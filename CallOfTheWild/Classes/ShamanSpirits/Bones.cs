        ...
        public class BonesSpirit
        {
            ...
            void createSpiritAbility()
            {
                ...
                var touch_of_the_grave_ability = Helpers.CreateAbility(touch_of_the_grave_prefix + "TouchOfGraveAbility",
                                                                       ...
                                                                       ? "As a standard action, the shaman can make a melee touch attack infused with negative energy that deals 1d6 points of damage plus 1d6 point of damage for every 2 shaman levels she possesses beyond the first. She can instead touch an undead creature to heal it of the same amount of damage. A shaman can use this ability a number of times per day equal to 3 + her Charisma modifier"
