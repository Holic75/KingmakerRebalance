...
namespace CallOfTheWild
{
    public partial class SpiritsEngine
    {
        public class BattleSpirit
        {
            ...
            public Archetypes.SpiritWhisperer.Spirit createSpirirtWhispererSpirit(HexEngine associated_hex_engine, string asset_prefix, string manifestation_asset_prefix, bool test = false)
            {
                test_mode = test;
