...
namespace CallOfTheWild
{
    class Spiritualist
    {
        ...
        static void createMasterfulFaith()
        {
            ...
            animal_domain.AddComponent(Common.prerequisiteNoArchetype(priest_of_the_fallen));
        ...
        static void createChannelEnergy()
        {
            ...
            channel_energy = Helpers.CreateFeatureSelection("PriestOfTheFallenChannelEnergySelection",
                                                                        "Channel Energy",
                                                                        $"At 3rd level, a priest of the fallen can channel her phantom’s divine energy. This functions as the cleric’s channel energy class feature, except that the amount of damage dealt or hit points restored is equal to 1d{BalanceFixes.getDamageDieString(DiceType.D6)} points plus an additional 1d{BalanceFixes.getDamageDieString(DiceType.D6)} points for every 2 spiritualist levels beyond 3rd. She can use this ability a number of times per day equal to her Charisma modifier (minimum 1).",
                                                                        "",
            ...
            var positive_heal = ChannelEnergyEngine.createChannelEnergy(ChannelEnergyEngine.ChannelType.PositiveHeal, "PriestOfTheFallenPostiveHeal", "",
                                                                        $"Channeling positive energy causes a burst that heals all living creatures in a 30 - foot radius centered on the spiritualist. The amount of damage healed is equal to 1d{BalanceFixes.getDamageDieString(DiceType.D6)} points plus an additional 1d{BalanceFixes.getDamageDieString(DiceType.D6)} points for every 2 spiritualist levels beyond 3rd.",
                                                                        "",
            ...
            var positive_harm = ChannelEnergyEngine.createChannelEnergy(ChannelEnergyEngine.ChannelType.PositiveHarm, "PriestOfTheFallenPostiveHarm", "",
                                                                        $"Channeling energy causes a burst that damages all undead creatures in a 30 - foot radius centered on the spiritualist. The amount of damage dealt is equal to 1d{BalanceFixes.getDamageDieString(DiceType.D6)} points plus an additional 1d{BalanceFixes.getDamageDieString(DiceType.D6)} points for every 2 spiritualist levels beyond 3rd. Creatures that take damage from channeled energy receive a Will save to halve the damage. The DC of this save is equal to 10 + 1/2 the spiritualist's level + the spiritualist's Charisma modifier.",
                                                                        "",
                                                                        context_rank_config, dc_scaling, resource_logic);
            var negative_heal = ChannelEnergyEngine.createChannelEnergy(ChannelEnergyEngine.ChannelType.NegativeHeal, "PriestOfTheFallenNegativeHeal", "",
                                                                        $"Channeling negative energy causes a burst that heals all undead creatures in a 30 - foot radius centered on the spiritualist. The amount of damage healed is equal to 1d{BalanceFixes.getDamageDieString(DiceType.D6)} points plus an additional 1d{BalanceFixes.getDamageDieString(DiceType.D6)} points for every 2 spiritualist levels beyond 3rd.",
                                                                        "",
                                                                        context_rank_config, dc_scaling, resource_logic);
            var negative_harm = ChannelEnergyEngine.createChannelEnergy(ChannelEnergyEngine.ChannelType.NegativeHarm, "PriestOfTheFallenNegativeHarm", "",
                                                                       $"Channeling energy causes a burst that damages all living creatures in a 30 - foot radius centered on the spiritualist. The amount of damage dealt is equal to 1d{BalanceFixes.getDamageDieString(DiceType.D6)} points plus an additional 1d{BalanceFixes.getDamageDieString(DiceType.D6)} points for every 2 spiritualist levels beyond 3rd. Creatures that take damage from channeled energy receive a Will save to halve the damage. The DC of this save is equal to 10 + 1/2 the spiritualist's level + the spiritualist's Charisma modifier.",
                                                                       "",
                                                                       context_rank_config, dc_scaling, resource_logic);
