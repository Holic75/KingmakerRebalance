    ...
    public class Oracle
    {
        ...
        static void createBonesMystery()
        {
            ...
            var deaths_touch = mystery_engine.createDeathsTouch("DeathsTouchOracleRevelation",
                                                                ...
                                                                ? "You can cause terrible wounds to appear on a creature with a melee touch attack. This attack deals 1d6 points of negative energy damage plus 1d6 points for every two oracle levels you possess beyond the first. If used against an undead creature, it heals damage and grants a +2 channel resistance for 1 minute. You can use this ability a number of times per day equal to 3 + your Charisma modifier."
