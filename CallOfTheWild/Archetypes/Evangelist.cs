    ...
    class Evangelist
    {
        ...
        static void createChannelEnergy()
        {
            ...
            var heal_living = ChannelEnergyEngine.createChannelEnergy(ChannelEnergyEngine.ChannelType.PositiveHeal,
                                                                      ...
                                                                      "",
                                                                      "Channeling positive energy causes a burst that heals all living creatures in a 30 - foot radius centered on the evangelist. The amount of damage healed is equal to 1d6 at level 3 and increases by 1d6 every 2 levels except at levels 9 and 15.",
                                                                      "",
                                                                      context_rank_config,
                                                                      dc_scaling,
            ...
            var heal_undead = ChannelEnergyEngine.createChannelEnergy(ChannelEnergyEngine.ChannelType.NegativeHeal,
                                              ...
                                              "",
                                              "Channeling positive energy causes a burst that heals all undead creatures in a 30 - foot radius centered on the evangelist. The amount of damage healed is equal to 1d6 at level 3 and increases by 1d6 every 2 levels except at levels 9 and 15.",
                                              "",
                                              context_rank_config,
                                              dc_scaling,
                                              Helpers.CreateResourceLogic(resource, true, 1));
