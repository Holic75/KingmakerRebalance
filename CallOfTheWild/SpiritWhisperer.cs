    ...
    public class SpiritWhisperer
    {
        ...
        public class Spirit
        {
                ...
                BlueprintFeature spirit_ability, BlueprintFeature greater_spirit_ability, BlueprintFeature manifestation, BlueprintFeature[] hexes)
            {
                ...
                progression = Helpers.CreateProgression(name + "SpiritWhispirerSpiritProgression",
                                                        display_name + " Spirit",
                                                        description,
                                                        "",
                                                        icon,
        ...
        public static void create()
        {
            ...
            shaman_familiar = library.CopyAndAdd<BlueprintFeatureSelection>("363cab72f77c47745bf3a8807074d183", "SpiritWhispirerSpiritAnimal", "dc6e4b01140349e39806ace27ed1140e");
            shaman_familiar.DlcType = Kingmaker.Blueprints.Root.DlcType.None;
            shaman_familiar.ComponentsArray = new BlueprintComponent[0];
            shaman_familiar.SetNameDescription("Arcane Bond",
            ...
            archetype.AddFeatures = new LevelEntry[] { Helpers.LevelEntry(1, spirit_selection),
        ...
        static void createSpiritSelection()
        {
            ...
            spirits.Add("Battle", battle_spirit.createSpirirtWhispererSpirit(hex_engine, "Shaman", "", test_mode));
            spirits.Add("Bones", bones_spirit.createSpiritWhispererSpirit(hex_engine, "Shaman", test_mode));
            spirits.Add("Flame", flame_spirit.createSpiritWhispererSpirit(hex_engine, "Shaman", test_mode));
            spirits.Add("Stone", stone_spirit.createSpiritWhispererSpirit(hex_engine, "Shaman", test_mode));
            spirits.Add("Waves", waves_spirit.createSpiritWhispererSpirit(hex_engine, "Shaman", test_mode));
            spirits.Add("Wind", wind_spirit.createSpiritWhispererSpirit(hex_engine, "Shaman", test_mode));
            spirits.Add("Nature", nature_spirit.createSpiritWhispererSpirit(hex_engine, "Shaman", test_mode));
            spirits.Add("Lore", lore_spirit.createSpiritWhispererSpirit(hex_engine, "Shaman", test_mode));
            spirits.Add("Heavens", heavens_spirit.createSpiritWhispererSpirit(hex_engine, "Shaman", test_mode));
            spirits.Add("Life", life_spirit.createSpiritWhispererSpirit(hex_engine, "Shaman", test_mode));
        ...
        {
            spirit_hex_selection = Helpers.CreateFeatureSelection("SpiritWhispererHexSelection",
                                                                   "Spirirt Hex",
